...
*body
  ...
  -resturant container
      -resturant card
        -img
        -name of resturant, stars , cuisine , delivery timer
*footer
  -links
  -copyright
  -address
  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSAe1GKC_TyWYOn3w6MEADIgoO22CaZSec5Q&s"
          alt="logo"
        />
      </div>
...
const resList = [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-06-07 04:45:00",
        opened: true
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-06-06 22:55:00",
        opened: true
      },
      badges: {
        imageBadges: [
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/new-freeze-land-motera-ellisbridge-ahmedabad-65400",
      type: "WEBLINK"
    }
  },
  {
    info: {
      ...
      cloudinaryImageId: "RX_THUMBNAIL/IMAGES/VENDOR/2024/6/3/6c23f86c-8b57-47ae-9660-2ff0fad99fee_762592.JPG",
      locality: "Ellisbridge",
      areaName: "Majestic Law Garden",
      costForTwo: "₹400 for two",
      deliveryTime: 16,
      cuisines: [
        "Beverages",
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/starbucks-coffee-ellisbridge-majestic-law-garden-ahmedabad-762592",
      type: "WEBLINK"
    }
  },
  {
    info: {
      id: "40831",
      name: "Subway",
      cloudinaryImageId: "RX_THUMBNAIL/IMAGES/VENDOR/2024/6/4/4fe8d129-44fd-469e-9eda-a1416a6dffcd_40831.JPG",
      locality: "Mithakali",
      areaName: "Navrangpura",
      costForTwo: "₹350 for two",
      deliveryTime: 23,
